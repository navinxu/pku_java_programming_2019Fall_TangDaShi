...
public class Week10Homework extends JFrame {
    ...
    /**
     * Check JTextField if numbers and dot If input one more dot or input an invalid
     * value, it skipped.
     */
    private void checkIfNumberic(JTextField textField) {
        textField.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                ...
                if (("0123456789.".indexOf(c) < 0 || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE))) {
                    e.consume();
                }
            }
        });
    ...
    /**
     * Check numeric and dot Return true means check pass.
     */
    ...
    public Week10Homework() {
        ...
        btnbmi.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                Double d = bmi;
                /*
                 * < 18.5 过轻 某些疾病和某些癌症患病率增高 18.5－23.9 正常 24－27.9 超重 >28 肥胖
                 */
                if (d.compareTo(Double.parseDouble("" + 18.5)) < 0) {
                    tfdNotice.setText("您的 BMI 值过低！");
                } else if (d.compareTo(Double.parseDouble("" + 18.5)) >= 0
                        && d.compareTo(Double.parseDouble("" + 23.9)) <= 0) {
                    tfdNotice.setText("您的 BMI 值正常！");
                } else if (d.compareTo(Double.parseDouble("" + 24)) >= 0
                        && d.compareTo(Double.parseDouble("" + 27.9)) <= 0) {
