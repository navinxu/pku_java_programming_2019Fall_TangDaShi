...
public class Week07Homework {
    public static void main(String[] args) {
        ...
        try {
            ...
            Account user1 = new Account("user1", "passw1");
            Account user2 = new Account("user2", "passw2");
            Account user3 = new Account("user3", "passw3");
            Account user4 = new Account("user4", "passw4");
            Account user5 = new Account("user5", "passw5");
            ...
            // 登录
            bank.login("user1", "passw1");
            bank.login("user2", "passw2");
            bank.login("user3", "passw3");
            bank.login("user4", "passw4");
            bank.login("user5", "passw5");
